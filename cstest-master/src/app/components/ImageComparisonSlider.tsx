...
interface ImageComparisonSliderProps {
  baseImage: string; // Kibble image
  overlayImage: string; // Raw food image
  className?: string;
}

export function ImageComparisonSlider({ baseImage, overlayImage, className = '' }: ImageComparisonSliderProps) {
  ...
  return (
    ...
    >
      ...
      {/* White Divider Line */}
      <div
        className="absolute top-0 h-full w-1 bg-white shadow-lg transition-all duration-100 ease-out pointer-events-none"
